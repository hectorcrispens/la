...
@section('menu')
    @include('MesaDeAyuda.menu.CU21menu')
    @endsection
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                       ...
                       <a href="{{ url('CU21AgruparPorLegajo2') }}"> <button class="btn bg-teal waves-effect m-b-15" type="button" >
                                        ...
                                        <div class="dd">
                                            <ol class="dd-list">
                                                <li class="dd-item" data-id="1">
                                                    <div class="dd-handle col-pink" style="overflow: hidden; "><b>LEGAJO: </b><b class="col-grey">566</b></div>
                                                    <ol class="dd-list">
                                                        <li class="dd-item" data-id="1">
                                                            <div class="dd-handle col-pink" style="overflow: hidden; "><b>APELLIDO: </b><b class="col-grey">Rattero</b></div>
                                                        </li>
                                                        <li class="dd-item" data-id="1">
                                                            <div class="dd-handle col-pink" style="overflow: hidden; "><b>NOMBRES: </b><b class="col-grey">Lisandro Adolfo</b></div>
                                                        </li>
                                                        <li class="dd-item" data-id="1">
                                                            <div class="dd-handle col-pink" style="overflow: hidden; "><b>TELÉFONO INTERNO: </b><b class="col-grey">114</b></div>
                                                        </li>
                                                        <li class="dd-item" data-id="1">
                                                            <div class="dd-handle col-pink" style="overflow: hidden; "><b>TELÉFONO DIRECTO: </b><b class="col-grey">53454366</b></div>
                                                        </li>
                                                        <li class="dd-item" data-id="1">
                                                            <div class="dd-handle col-pink" style="overflow: hidden; "><b>DESCRIPCIÓN DEL CARGO: </b><b class="col-grey">Encargado</b></div>
                                                        </li>
                                                        <li class="dd-item" data-id="1">
                                                            <div class="dd-handle col-pink" style="overflow: hidden; "><b>UBICACIÓN: </b></div>
                                                            <ol class="dd-list">
                                                                <li class="dd-item" data-id="1">
                                                                    <div class="dd-handle col-cyan" style="overflow: hidden; "><b>Calle: </b><b class="col-grey">Av San Martín</b></div>
                                                                </li>
                                                                <li class="dd-item" data-id="1">
                                                                    <div class="dd-handle col-cyan" style="overflow: hidden; "><b>Calle: </b><b class="col-grey">Av San Martín</b></div>
                                                                </li>
                                                                <li class="dd-item" data-id="1">
                                                                    <div class="dd-handle col-cyan" style="overflow: hidden; "><b>Número: </b><b class="col-grey">343</b></div>
                                                                </li>
                                                                <li class="dd-item" data-id="1">
                                                                    <div class="dd-handle col-cyan" style="overflow: hidden; "><b>Piso: </b><b class="col-grey">3</b></div>
                                                                </li>
                                                                <li class="dd-item" data-id="1">
                                                                    <div class="dd-handle col-cyan" style="overflow: hidden; "><b>Oficina: </b><b class="col-grey">Administración</b></div>
                                                                </li>
                                                            </ol>
                                                        </li>
                                                        ...
                                                        <li class="dd-item " data-id="2">
                                                            ...
                                                            <div class="dd-handle col-pink" style="overflow: hidden; "><b>LISTA DE TICKETS:</b></div>
                                                                ...
                                                                <li class="dd-item " data-id="8">
                                                                    ...
                                                                    <ol class="dd-list">
                                                                        <li class="dd-item" data-id="9">
                                                                            <div class="dd-handle" style="overflow: hidden; "><b>Clasificación: </b><b class="col-grey">4008</b></div>
                                                                        </li>
                                                                        <li class="dd-item" data-id="9">
