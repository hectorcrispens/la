...
@section('menu')
    @include('MesaDeAyuda.menu.CU22menu')
    @endsection
...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>VISUALIZAR INFORMACIÓN POR ESTADOS</h2>
        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <a href="{{ url('/CU22AgruparPorEstado2') }}"><button class="btn bg-teal waves-effect m-b-15" type="button" >
                            ...
                            <div class="row clearfix">
                                <div class="col-md-12"><br><small>Reordenar los ticket según los siguientes criterios</small>
                                    ...
                                    <select id="mySelect" name="mySelect" style="width:100%;">
                                        ...
                                        <option value="Tiempo Total Acumulado de Atención">Tiempo Total Acumulado de Atención</option>
                                            ...
                                            <ol class="dd-list">
                                                <li class="dd-item" data-id="1">
                                                    <div class="dd-handle" style="overflow: hidden; ">
                                                        <b class="col-pink">DESCRIPCIÓN DE ESTADO: </b><b class="col-grey">Abierto Derivado</b>
                                                    </div>
                                                </li>
                                                <li class="dd-item" data-id="2">
                                                    <div class="dd-handle" style="overflow: hidden; ">
                                                        <b class="col-pink">TOTAL DE TICKET EN ESTADO: </b><b class="col-grey">114</b>
                                                    </div>
                                                </li>
                                                <li class="dd-item " data-id="3">
                                                    ...
                                                    <ol class="dd-list">
                                                        <li class="dd-item " data-id="4">
                                                            <div class="dd-handle" style="overflow: hidden; "><b>Número de Ticket: 56566 </b></div>
                                                            <ol class="dd-list">
                                                                ...
                                                                <li class="dd-item" data-id="7">
                                                                    <div class="dd-handle" style="overflow: hidden; "><b>Tiempo total acumulado de atencion: </b><b class="col-grey">12d-1h-20m</b></div>
                                                                </li>
                                                                ...
                                                                <li class="dd-item" data-id="9">
                                                                    <div class="dd-handle" style="overflow: hidden; "><b>Número de legajo: </b><b class="col-grey">4012</b></div>
                                                                </li>
                                                            </ol>
                                                        </li>
                                                    </ol>
                                                    <ol class="dd-list">
                                                        <li class="dd-item " data-id="4">
                                                            <div class="dd-handle" style="overflow: hidden; "><b>Número de Ticket: 56567 </b></div>
                                                            <ol class="dd-list">
                                                                <li class="dd-item" data-id="5">
                                                                    <div class="dd-handle" style="overflow: hidden; "><b>Clasificación actual de Ticket: </b><b class="col-grey">Problema de acceso a la red local o remota</b></div>
                                                                </li>
                                                    ...
                                                    <ol class="dd-list">
                                                        <li class="dd-item " data-id="4">
                                                            <div class="dd-handle" style="overflow: hidden; "><b>Número de Ticket: 56888 </b></div>
                                                            <ol class="dd-list">
                                                                <li class="dd-item" data-id="5">
                                                                    <div class="dd-handle" style="overflow: hidden; "><b>Clasificación actual de Ticket: </b><b class="col-grey">Problema de acceso a la red local o remota</b></div>
                                                                </li>
                                                    ...
                                                    <ol class="dd-list">
                                                        <li class="dd-item " data-id="4">
                                                            <div class="dd-handle" style="overflow: hidden; "><b>Número de Ticket: 57777 </b></div>
                                                            <ol class="dd-list">
                                                                <li class="dd-item" data-id="5">
                                                                    <div class="dd-handle" style="overflow: hidden; "><b>Clasificación actual de Ticket: </b><b class="col-grey">Problema de acceso a la red local o remota</b></div>
                                                                </li>
                                    ...
                                    <td>
                                        <div class="dd">
                                            <ol class="dd-list">
                                                <li class="dd-item" data-id="1">
                                                    <div class="dd-handle" style="overflow: hidden; ">
                                                        <b class="col-pink">DESCRIPCIÓN DE ESTADO: </b><b class="col-grey">Abierto Sin Derivar</b>
                                                    </div>
                                                </li>
                                                <li class="dd-item" data-id="2">
                                                    <div class="dd-handle" style="overflow: hidden; ">
                                    ...
                                    <td>
                                        <div class="dd">
                                            <ol class="dd-list">
                                                <li class="dd-item" data-id="1">
                                                    <div class="dd-handle" style="overflow: hidden; ">
                                                        <b class="col-pink">DESCRIPCIÓN DE ESTADO: </b><b class="col-grey">A La Espera OK</b>
                                                    </div>
                                                </li>
                                                <li class="dd-item" data-id="2">
                                                    <div class="dd-handle" style="overflow: hidden; ">
